...
import { Badge, Button, Divider, Heading, Subheading, Text } from "@package/ui";
...
export function SurveyForm({
  ...
  const getHoverClasses = (score: number) => {
    const hoverClassMap = {
      1: "border-slate-200 bg-white hover:border-red-300 hover:bg-red-50",
      2: "border-slate-200 bg-white hover:border-orange-300 hover:bg-orange-50",
      3: "border-slate-200 bg-white hover:border-gray-300 hover:bg-gray-50",
      4: "border-slate-200 bg-white hover:border-blue-300 hover:bg-blue-50",
      5: "border-slate-200 bg-white hover:border-green-300 hover:bg-green-50",
    };

    return (
      hoverClassMap[score as keyof typeof hoverClassMap] || hoverClassMap[3]
    );
  };
        ...
        <div className="space-y-4 text-center">
          ...
          <div className="rounded-xl border border-blue-200 bg-gradient-to-br from-white to-blue-50 p-6 shadow-lg">
            <div className="mb-4 flex items-center justify-between">
              ...
              <Badge
                color={
                  completedQuestions === questions.length ? "green" : "blue"
                }
              >
